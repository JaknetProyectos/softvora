...
export default function CheckoutPage() {
  ...
  const totalWithTax = useMemo(() => totalPrice * 1.16, [totalPrice]);
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(245,158,11,0.12),_transparent_35%),linear-gradient(180deg,#ffffff_0%,#fff7ed_100%)] text-zinc-900">
        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.25fr_0.95fr] lg:px-8">
          <form
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl border border-yellow-100 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
              ...
              <div className="space-y-4">
                {items.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-yellow-200 bg-yellow-50/60 p-6 text-center text-sm text-zinc-600">
                    {t("summary.empty")}
                  </div>
                ) : (
                  items.map((item) => (
              ...
              <div className="mt-6 space-y-3 border-t border-zinc-100 pt-6">
                ...
                <div className="flex items-center justify-between text-sm text-zinc-600">
                  ...
                  <span>{formatMoney(totalPrice * 0.16)}</span>
                </div>
            ...
            <div className="rounded-3xl border border-yellow-100 bg-gradient-to-br from-yellow-50 to-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.04)]">
              ...
              <div className="flex w-full flex-row justify-center gap-6 p-6">
                <Image
                  src="/cards.png"
                  width={100}
                  height={30}
